/**
 * 지정된 함수에서 적절한 타입을 제공하세요.
 *
 * 가능하면 코드 중복을 줄이기 위해 코드를 리팩토링하세요.
 * 그것을 정말로 짧게 만들기 위해 과도한 타입 캐스팅이 필요할 수도 있습니다.
 */
...
interface PipeFunc {
  ...
  <A1 extends unknown[], R1, R2, R3>(f: F<A1, R1>, tr1: TR<R1, R2>, tr2: TR<R2, R3>): (
    ...args: A1
  ) => R3
